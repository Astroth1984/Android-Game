...
public class ArrangeScreen2 extends Screen {
    ...
    public ArrangeScreen2(Game game) {
        super(game);
    ...
    private void putContainers() {
        ...
        e1= new Event(DailyRoutine2Assets.classes, w_unitc/3,1*h_unitc,h_unitc,wu,1);
        addSprite(e1);
        events.add(e1);
        e2= new Event(DailyRoutine2Assets.dressed, w_unitc/3+wu,1*h_unitc,h_unitc,wu,2);
        addSprite(e2);
        events.add(e2);
        e3= new Event(DailyRoutine2Assets.gotoschool, w_unitc/3+2*wu,1*h_unitc,h_unitc,wu,3);
        addSprite(e3);
        events.add(e3);
